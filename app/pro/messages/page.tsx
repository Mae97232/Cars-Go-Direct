...
import { Search, Send, Phone, Mail, Circle, ArrowLeft } from "lucide-react";
            ...
            {activeConversation ? (
                ...
                <div className="flex-1 space-y-4 overflow-y-auto px-4 py-5 sm:px-6 sm:py-6">
                  {activeConversation.messages.length ? (
                    activeConversation.messages.map((message, index) => {
                      ...
                      const buyerInitials =
                        getInitials(activeConversation.buyer_name) || "C";
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {mine ? (
                              <div className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-slate-900 text-xs font-semibold text-white sm:h-10 sm:w-10">
                                P
                              </div>
                            ) : (
                              <Avatar
                              ...
                              <div
                                className={
                                  mine
                                    ...
                                    : "break-words rounded-2xl rounded-tl-md bg-slate-100 px-3 py-2.5 text-sm leading-6 text-slate-800 sm:px-4 sm:py-3"
                                }
                              >
                                {message.content}
                              </div>
              ...
              <div className="grid h-full place-items-center px-6 py-20">
                <div className="max-w-md text-center">
                  ...
                  <p className="mt-2 text-sm leading-7 text-slate-600">
                    Choisissez un échange pour afficher les messages et répondre à l’acheteur.
                  </p>
                </div>
              </div>
            )}
