  ...
  return (
    <div className="flex flex-col gap-4 border-b border-slate-200 py-6 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <span className="inline-flex rounded-full bg-slate-100 px-3 py-2 text-xs font-medium text-slate-700">
          {status}
        </span>

        <button
          type="button"
          className="inline-flex h-11 items-center justify-center gap-2 rounded-md border border-slate-300 bg-white px-4 text-sm font-medium text-slate-700 transition hover:border-orange-400 hover:bg-orange-50 hover:text-orange-600"
        >
  ...
  return (
    <div className="mx-auto max-w-5xl bg-white text-slate-900">
      <div className="flex flex-wrap items-center gap-2 text-sm text-slate-500">
        <Link href="/compte" className="font-medium text-slate-700 hover:text-orange-600 hover:underline">
          Mon compte
        </Link>
        <span>›</span>
        <span>Factures</span>
