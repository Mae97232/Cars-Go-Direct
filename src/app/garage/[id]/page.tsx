            ...
            <div className="flex flex-wrap gap-2">
              {typedGarage.phone ? (
                <a
                  ...
                  className="inline-flex h-11 items-center gap-2 rounded-md bg-orange-500 px-4 text-sm font-medium text-white transition hover:bg-orange-600"
                >
              ...
              <Link
                href="/annonces"
                className="inline-flex h-11 items-center gap-2 rounded-md border border-slate-300 bg-white px-4 text-sm font-medium text-slate-700 transition hover:border-orange-400 hover:bg-orange-50 hover:text-orange-600"
              >
                Retour aux annonces
              </Link>
            </div>
        ...
        <section className="grid gap-10 py-8 lg:grid-cols-[1.45fr_.95fr]">
          <div className="space-y-8">
            ...
            <div>
              ...
              {publishedListings.length === 0 ? (
                <div className="mt-6 border border-slate-200 bg-white p-10 text-center shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
                  ...
                  {publishedListings.map((item) => (
                    ...
                    >
                      <div className="flex flex-col md:flex-row">
                        <div className="h-52 w-full shrink-0 border-b border-slate-200 bg-slate-100 md:h-auto md:w-[280px] md:border-b-0 md:border-r">
                        ...
                        <div className="flex min-w-0 flex-1 flex-col justify-between p-5 sm:p-6">
                          ...
                          <div className="mt-6 flex flex-wrap gap-2">
                            <Link
                              ...
                              className="inline-flex h-10 items-center gap-2 rounded-md border border-slate-300 bg-white px-4 text-sm font-medium text-slate-700 transition hover:border-orange-400 hover:bg-orange-50 hover:text-orange-600"
                            >
          ...
          <aside className="space-y-8">
            <div>
              ...
              <div className="mt-5 border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
                <div className="space-y-4 text-sm text-slate-700">
                  ...
                  {typedGarage.phone ? (
                    <div className="flex items-start gap-3">
                      ...
                      <a href={`tel:${typedGarage.phone}`} className="hover:text-orange-600">
                        {typedGarage.phone}
                      </a>
                    </div>
                  ) : null}
