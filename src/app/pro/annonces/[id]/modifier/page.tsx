    ...
    <div className="mx-auto grid max-w-6xl gap-5">
      <div className="card p-6 sm:p-7">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <h1 className="text-2xl font-extrabold tracking-tight">Modifier une annonce</h1>
        ...
        <div className="mt-6 grid gap-2 sm:grid-cols-2">
          ...
          <div className={step === 2 ? "card border-slate-300 p-4" : "card p-4 opacity-70"}>
            ...
            <p className="font-semibold">Aperçu & sauvegarde</p>
          </div>
        </div>
      </div>
      ...
      {step === 1 ? (
          ...
          <section className="card p-6">
            ...
            <div className="mt-4 grid gap-3">
              ...
              {existingPhotos.length > 0 && (
                <div className="grid gap-2">
                  <p className="text-sm font-semibold">Photos actuelles</p>
              ...
              {existingPhotos.length === 0 && newPhotos.length === 0 && (
                <div className="text-sm text-slate-500">Aucune photo pour cette annonce.</div>
              )}
            </div>
          </section>
        </div>
        ...
        <div className="grid gap-5 lg:grid-cols-[1.15fr_.85fr] lg:items-start">
          ...
          <aside className="grid gap-5">
            <section className="card p-6">
              <h3 className="text-base font-bold tracking-tight">Sauvegarde</h3>
              <p className="mt-2 text-sm text-slate-600">
